<x-frame>
    ...
    <x-slot:slot_about>
        ...
        <div class="section bg1">
            <h1 class="about-heading revealUp">About Us</h1>
            <p class="about-p1">Fast Food Delight welcomes you to a world where culinary excellence meets the
                ...
                patrons with fast food that transcends the ordinary, offering tantalizing taste and unparalleled
                quality
                that leaves a lasting impression.</p>
        </div>

        <div class="section">
            <h2 class="about-subheading revealUp">Our Story</h2>
            <p class="about-p">Our epic journey embarked on an exciting path back in the year 20XX when our
                visionary
            ...
            <div class="expand-button about-p">
                <div tabindex="0"><span>
                        <p>Our commitment to excellence has remained steadfast throughout our
                        ...
                        <p>Our menu is a testament to our relentless pursuit
                            of
