<x-frame>
    ...
    <section class="shop" id="shop">
        <div class="heading">
            <h4>Our <span>Popular</span> Menu</h4>
        </div>
        <div class="shop-content">
            <div class="row">
                <img src="https://pngimg.com/uploads/burger_sandwich/burger_sandwich_PNG4142.png"
                    alt="">
                <h3>Burger</h3>
            ...
            <div class="row">
                <img src="https://pngimg.com/d/burger_sandwich_PNG4157.png"
                    alt="">
                <h3>Burger 2</h3>
                <p>Lorem ipsum dolor sit amet.</p>
                <div class="intext">
